...
import { employerJobColumns } from "@/components/Columns/EmployerJobColumns";
...
const EmployerJobPage = () => {
  const { data: employerJobData, isLoading } = useFetchPersonalJobs();
