...
import { LinkedInLogo, AsanaLogo, ToyotaLogo, ZoomLogo } from "./company-logos"
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
        <div className="grid items-center gap-8 sm:gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-6 sm:space-y-8">
            <h1
              className={`text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-black transition-all duration-1000 delay-300 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
              The intelligent way to build your talent pipeline.
            </h1>

            <p
              className={`max-w-md text-sm sm:text-base leading-relaxed text-gray-600 transition-all duration-1000 delay-500 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
              Get matched with pre-vetted interns in under 2 hours. Focus on what matters while we handle the hiring
              heavy lifting.
            </p>

            <div
              className={`flex flex-wrap gap-3 sm:gap-4 transition-all duration-1000 delay-700 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
            ...
            <div
              className={`flex flex-wrap gap-8 sm:gap-12 pt-4 transition-all duration-1000 delay-900 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
              <div className="flex items-baseline gap-2">
                <div className="text-3xl sm:text-4xl font-semibold text-black leading-none">2943</div>
              ...
              <div className="flex items-baseline gap-2">
                <div className="text-3xl sm:text-4xl font-semibold text-black leading-none">1M+</div>
                <div className="text-xs sm:text-sm text-gray-500 leading-tight">Networked</div>
              </div>
            </div>
          </div>
