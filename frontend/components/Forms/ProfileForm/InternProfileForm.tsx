...
import { internProfileFormSchema } from "@/lib/schema";
...
const InternProfileForm = () => {
  ...
  const form = useForm<z.infer<typeof internProfileFormSchema>>({
  ...
  const onSubmit = async (values: z.infer<typeof internProfileFormSchema>) => {
