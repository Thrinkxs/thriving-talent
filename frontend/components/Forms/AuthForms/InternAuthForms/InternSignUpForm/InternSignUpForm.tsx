...
import { internSignUpSchema } from "@/lib/schema";
...
export default function InternSignUpForm() {
  ...
  const methods = useForm<z.infer<typeof internSignUpSchema>>({
  ...
  const nextStep = async () => {
    let stepFields: (keyof z.infer<typeof internSignUpSchema>)[] = [];
  ...
  const onSubmit = async (formValues: z.infer<typeof internSignUpSchema>) => {
