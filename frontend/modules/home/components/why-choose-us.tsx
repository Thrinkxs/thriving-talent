          ...
          >
            <h3 className="text-2xl sm:text-3xl lg:text-3xl font-bold leading-tight text-black">
              ...
              <span
                ...
                style={{
                  backgroundImage: "linear-gradient(90deg, #FE2728 49.04%, #2020D0 100%)",
                  whiteSpace: "nowrap",
                }}
              >
                AI-driven
              ...
              <span
                className="bg-clip-text text-transparent"
                style={{
                  backgroundImage: "linear-gradient(90deg, #000000 0%, #606060 100%)",
                }}
              >
          ...
          <div className="lg:col-span-2">
            <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 lg:grid-rows-2">
              {stats.map((stat, index) => (
                <div
                  key={stat.id}
                  className={`${stat.bgGradient} rounded-2xl p-6 sm:p-8 text-white transition-all duration-1000 hover:scale-105 hover:shadow-2xl ${stat.position} ${
                    isVisible
