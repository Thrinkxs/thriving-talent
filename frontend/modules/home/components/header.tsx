    ...
    <header className="border-b border-gray-100 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between gap-4">
          {/* Logo */}
          <div
            className={`flex-shrink-0 transition-all duration-700 ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0"}`}
          >
          ...
          <nav
            className={`hidden md:flex items-center gap-6 lg:gap-8 transition-all duration-700 delay-100 ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-10 opacity-0"}`}
          >
            <a href="/" className="text-sm font-medium text-gray-900 transition-colors hover:text-blue-600">
              Jobs
            </a>
            <a href="/" className="text-sm font-medium text-gray-900 transition-colors hover:text-blue-600">
              Companies
          ...
          <div
            className={`flex items-center gap-2 sm:gap-3 transition-all duration-700 delay-200 ${isVisible ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"}`}
          >
            <Link
              href="/login"
        ...
        {mobileMenuOpen && (
          <div className="sm:hidden mt-4 pb-4 border-t border-gray-100">
            <nav className="flex flex-col gap-3 py-4">
              <a href="/" className="text-sm font-medium text-gray-900 transition-colors hover:text-blue-600 px-3 py-2">
                Jobs
              </a>
              <a href="/" className="text-sm font-medium text-gray-900 transition-colors hover:text-blue-600 px-3 py-2">
                Companies
